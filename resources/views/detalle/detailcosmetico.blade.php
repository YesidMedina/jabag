        ...
        <div class="fondo">
            <div class="tm-bg-gray tm-video-details">
                ...
                <div class="d-flex justify-content-center align-items-center">
                    <div class="mr-4 mb-2">
                        <span class="d-flex justify-content-center align-items-center">Precio: </span><span class="tm-text-primary">{{ $cosmetico->precio }}<sup> COP</sup></span>
                    </div>
                    <div class="mr-4 mb-2">
                        <span class="d-flex justify-content-center align-items-center">Código: </span><span class="tm-text-primary">{{ $cosmetico->codigo }}</span>
                    </div>
                </div>
                <div class="mb-4">
                    <span class="d-flex justify-content-center align-items-center">Descripción:</span>
                    <font face="georgia" size="4px;">{{ $cosmetico->descripcion }}</font>
                </div>
