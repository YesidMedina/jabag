...
<body>
    ...
    <div class=" d-flex justify-content-center align-items-center">
        ...
        <h1>Detalle Del Producto {{$barberia->nombreProducto}}</h1>
    </div>
    <br>
    <br>
    <div class="tm-hero d-flex justify-content-center align-items-center" >
        ...
        <div class=" row d-flex justify-content-center " style=" width: auto; margin-bottom: 50px;">
            ...
            <div class="col-6" style="width: 400px;">
             <img src="../../public/img/{{$barberia->imagen }}" alt="Image" class="img-fluid d-flex justify-content-center">
            </div>
            ...
            <div class="col-6 justify-content-center" style="border-bottom: solid 1px #1A1919; font-size:50px;">
                ...
                <div class="justify-content-center tm-text-gray">
                    <span class="tm-text-gray-light px-2 text-dark ">{{ $barberia->nombreProducto }}</span>

                </div>
                <div class="justify-content-center tm-text-gray">
                    <span class="tm-text-gray-light px-2 text-dark">Codigo: {{ $barberia->codigo }}</span>
                </div>

                <div class="justify-content-center tm-text-gray">
                    <span class="tm-text-gray-light px-2 text-dark">Precio: {{ $barberia->precio }}</span>
                </div>

                <div class="justify-content-center tm-text-gray">
                    <span class="tm-text-gray-light px-2 text-dark">Descripcion: {{ $barberia->descripcion }}</span>
                </div>
