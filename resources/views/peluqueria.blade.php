        ...
        <div class="col-xl-4 col-lg-4 col-md-6 col-sm-6 " style=" width: auto;">
            ...
            <div>
                ...
                <div class="d-flex justify-content-center tm-text-gray"  style="border-bottom: solid 1px #1A1919;">
                    <span class="tm-text-gray-light px-2 text-dark ">{{ $peluquerium->nombreProducto }}</span>

                </div>
                <div class="d-flex justify-content-center tm-text-gray">
                    <span class="tm-text-gray-light px-2 text-dark">Codigo: {{ $peluquerium->codigo }}</span>
                </div>

                <div class="d-flex justify-content-center tm-text-gray">
                    <span class="tm-text-gray-light px-2 text-dark">Precio: {{ $peluquerium->precio }}</span>
                </div>
