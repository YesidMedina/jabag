    ...
    <div class="row d-flex justify-content-center">
        ...
        <div class="col-xl-4 col-lg-4 col-md-6 col-sm-6 " style=" width: auto;">
            ...
            <div class="display-6" style="border-bottom: solid 1px #1A1919;">
                ...
                <div class="d-flex justify-content-center tm-text-gray">
                    <span class="tm-text-gray-light px-1 text-dark"><a style="color:rgb(240, 71, 20)">Código:</a> {{ $peluquerium->codigo }}</span>
                </div>

                <div class="d-flex justify-content-center tm-text-gray">
                    <span class="tm-text-gray-light px-1 text-dark"><a style="color:rgb(240, 71, 20)">Precio:</a>{{ $peluquerium->precio }}<sup> COP</sup></span>
                </div>
